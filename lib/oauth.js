...
SimpleAuth.prototype.register = function(opts) {
  ...
  var AUTHORIZATION_URL = AUTH_URL + (opts.authorizationPath || '/authorize');
  var TOKEN_URL = AUTH_URL + (opts.tokenPath || '/token');
...
SimpleAuth.prototype.login = function(options) {
  ...
  return function (req, res, next) {
    ...
    return passport.authenticate(self.name, options, function(err, profile) {
      ...
      // TODO set the expiration based on what the auth app told us
